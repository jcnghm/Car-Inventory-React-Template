      ...
      <div className={classes.root}>
        ...
        >
          <Toolbar className={classes.toolbar}>
            ...
            <Button className={classes.toolbar_button} onClick={handleDialogClickOpen}>Add New Vehicle</Button>
                {/*Dialog Pop Up begin */}
              <Dialog open={dialogOpen} onClose={handleDialogClickClose} aria-labelledby="form-dialog-title">
                <DialogTitle id="form-dialog-title">Add New Vehicle</DialogTitle>
                <DialogContent>
                  <DialogContentText>Place Your Vehicle Info Here</DialogContentText>
                    <CarForm />
                </DialogContent>
                <DialogActions>
